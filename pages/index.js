...
// Define HomepageHeading component with mobile prop
const HomepageHeading = ({ mobile }) => (
  <Container text>
    ...
    <Header
      as="h1"
      content="Decentralized Access Control System"
      inverted
      style={{
    ...
    <Header
      as="h2"
      content="Medical Report Access Control"
      inverted
      style={{
...
// Define PropTypes for HomepageHeading component
HomepageHeading.propTypes = {
  mobile: PropTypes.bool,
};

// Define DesktopContainer component
